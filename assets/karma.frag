...
void main()
{
    ...
    gl_FragColor.rgb = vec3(ppDiffuse,ppDiffuse,ppDiffuse);//sample * ppDiffuse; // + vec3( ppSpecular, ppSpecular, ppSpecular );
    //gl_FragColor.rgb = vec3 ( ppDiffuse, ppDiffuse, ppDiffuse );
    gl_FragColor.a = 1.0;
}
